...
function render(list){
  if(!list.length){ grid.innerHTML = '<p>No deals yet. <a href="post_deal.html">Post a deal</a>.</p>'; return; }
...
async function apply(){
  ...
  else if(sort.value==='high'){ list.sort((a,b)=> Number(b.price)-Number(a.price)); }
